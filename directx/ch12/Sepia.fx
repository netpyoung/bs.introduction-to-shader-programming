...
struct ColorConversion_Sepia_Vertex_Shader_VS_INPUT 
{
   float4 mPosition : POSITION;
   float2 mUV : TEXCOORD0;   
};

struct ColorConversion_Sepia_Vertex_Shader_VS_OUTPUT 
{
   float4 mPosition : POSITION;
   float2 mUV : TEXCOORD0;
};

ColorConversion_Sepia_Vertex_Shader_VS_OUTPUT ColorConversion_Sepia_Vertex_Shader_vs_main( ColorConversion_Sepia_Vertex_Shader_VS_INPUT Input )
{
   ColorConversion_Sepia_Vertex_Shader_VS_OUTPUT Output;
...
struct ColorConversion_Sepia_Pixel_Shader_PS_INPUT
{
   float2 mUV : TEXCOORD0;
};
...
float4 ColorConversion_Sepia_Pixel_Shader_ps_main(ColorConversion_Sepia_Pixel_Shader_PS_INPUT Input) : COLOR
{
