...
// Emboss
//--------------------------------------------------------------//
string ColorConversion_Emboss_ScreenAlignedQuad : ModelData = "..\\..\\..\\..\\..\\Program Files (x86)\\AMD\\RenderMonkey 1.82\\Examples\\Media\\Models\\ScreenAlignedQuad.3ds";

struct ColorConversion_Emboss_Vertex_Shader_VS_INPUT 
{
   float4 mPosition : POSITION;
   float2 mUV : TEXCOORD0;   
};

struct ColorConversion_Emboss_Vertex_Shader_VS_OUTPUT 
{
   float4 mPosition : POSITION;
   float2 mUV : TEXCOORD0;
};

ColorConversion_Emboss_Vertex_Shader_VS_OUTPUT ColorConversion_Emboss_Vertex_Shader_vs_main( ColorConversion_Emboss_Vertex_Shader_VS_INPUT Input )
{
   ColorConversion_Emboss_Vertex_Shader_VS_OUTPUT Output;
...
struct ColorConversion_Emboss_Pixel_Shader_PS_INPUT
{
   float2 mUV : TEXCOORD0;
};
...
float4 ColorConversion_Emboss_Pixel_Shader_ps_main(ColorConversion_Emboss_Pixel_Shader_PS_INPUT Input) : COLOR
{
   float L = 0;
...
technique ColorConversion
{
   ...
   pass Emboss
   {
      ...
      VertexShader = compile vs_2_0 ColorConversion_Emboss_Vertex_Shader_vs_main();
      PixelShader = compile ps_2_0 ColorConversion_Emboss_Pixel_Shader_ps_main();
   }
